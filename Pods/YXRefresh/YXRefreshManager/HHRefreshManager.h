...
@property (nonatomic, assign) BOOL isHeaderNoMore;//头部数据更多数据提示
@property (nonatomic, assign) BOOL isFooterNoMore;//底部数据更多数据提示
@property (nonatomic, strong) NSString * noMoreString;//没有数据更多数据提示
