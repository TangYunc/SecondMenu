...
-(void)setModel:(LXCalendarDayModel *)model{
    ...
    if (model.isNextMonth || model.isLastMonth) {
        ...
        if (model.isSelected) {
            ...
            self.label.textColor = model.selectTitleColor?model.selectTitleColor:[UIColor redColor];
        ...
        if (model.isToday) {
            ...
            self.label.backgroundColor = model.todayBackColor?model.todayBackColor:[UIColor greenColor];
        }
    }
