...
-(void)responData{
    ...
    self.calendarHeader.dateStr = [NSString stringWithFormat:@"%ld/%@",monthModel.year,monthStr];
...
- (void)setDataLabelColor:(UIColor *)dataLabelColor{
    _dataLabelColor = dataLabelColor;
    self.calendarHeader.dataLabelColor = dataLabelColor;
}
